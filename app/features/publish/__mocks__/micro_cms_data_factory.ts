...
export const MicroCmsDataFactory = Factory.define<MicroCmsApiSchema>(({ sequence }) => ({
  id: `y-ls6f3ms62${sequence}`,
  createdAt: '2022-12-31T16:24:08.165Z',
  updatedAt: '2023-04-02T04:10:09.765Z',
